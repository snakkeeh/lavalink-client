...
// If you use NodeLink nodes, you can optionally override the default
// source mapping to use NodeLink-specific prefixes (admsearch, gaanasearch, gtts, etc.)
//
// import { NodeLinkDefaultSources } from "lavalink-client";
// client.lavalink.utils.SourcesRecord = NodeLinkDefaultSources;
//
// Or extend it with your own aliases:
